...
- Uncensored media (pre-regulation films, books, music).
- Forbidden art (optical illusions, stereograms, depth-texture works).
- Illegal pattern-wear fabric.
- Pattern-bar memberships.
- Strong perfume.
...
- **Pattern bars** are often informal black market venues. Forbidden art changes hands. Smugglers meet clients.
- **Stink dens** sometimes serve as scent-component drop points (the chaotic environment masks the deposit).
- **Underground livestream channels** distribute uncertified media.
- **Dark commerce networks** route physical components through legal-product cover (perfume bottles, candles, art prints).
...
A real subculture. Often former Stim Response officers. Work for insurance companies tracking down components after attacks, for governments hunting brokers, for private clients seeking memory recovery or grief suppression. Morally gray. Tools include AR-overlaid pattern signatures, scent-detection rigs, contacts inside pattern bars.

A plausible protagonist archetype lives here.

## Folk economics

The black market exists because the legal market does too little for too many people:

- Sleep medicine is rationed and bureaucratic; the black market sells effective sleep tonight.
- Bound-care is overwhelmed; black-market sensory doctors take walk-ins.
- Grief therapy is gated; the black market sells grief erasure (with risks).
- Old art is illegal; the underground keeps it alive.

Most participants are not criminals in spirit. They are people the system failed.
